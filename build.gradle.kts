    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation("io.github.kotlinmania:url-kotlin:0.1.1")
            }
        }
        val commonTest by getting {
            dependencies {
                implementation(kotlin("test"))
                implementation("io.github.kotlinmania:pretty-assertions-kotlin:0.1.1")
                implementation("io.github.kotlinmania:thiserror-kotlin:0.1.1")
...
dependencies {
    ...
    codeqlSourceClasspath("io.github.kotlinmania:owo-colors-kotlin-jvm:0.1.1")
    codeqlSourceClasspath("io.github.kotlinmania:url-kotlin-jvm:0.1.1")
}
