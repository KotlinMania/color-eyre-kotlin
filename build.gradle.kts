...
kotlin {
    ...
    swiftExport {
        moduleName = "ColorEyre"
        flattenPackage = "io.github.kotlinmania.coloreyre"
    }

    android {
        namespace = "io.github.kotlinmania.coloreyre"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation("io.github.kotlinmania:once-cell-kotlin:0.1.2")
                implementation("io.github.kotlinmania:owo-colors-kotlin:0.1.2")
                implementation("io.github.kotlinmania:url-kotlin:0.1.2")
            }
        }
        val commonTest by getting {
            dependencies {
                implementation(kotlin("test"))
                implementation("io.github.kotlinmania:pretty-assertions-kotlin:0.1.2")
                implementation("io.github.kotlinmania:thiserror-kotlin:0.1.2")
                implementation("io.github.kotlinmania:tracing-kotlin:0.1.2")
                implementation("io.github.kotlinmania:tracing-subscriber-kotlin:0.1.2")
            }
        }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "color-eyre-kotlin", version.toString())

    pom {
        name.set("color-eyre-kotlin")
        description.set("Kotlin Multiplatform port of eyre-rs/eyre - An error report handler for panics and eyre::Reports for colorful, consistent, and well formatted error reports for all kinds of errors")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/color-eyre-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/color-eyre-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/color-eyre-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/color-eyre-kotlin.git")
        }
    }
}
...
dependencies {
    ...
    codeqlSourceClasspath("io.github.kotlinmania:owo-colors-kotlin-jvm:0.1.2")
    codeqlSourceClasspath("io.github.kotlinmania:url-kotlin-jvm:0.1.2")
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.coloreyre.codeql
