...
This file is the quick-reference operating contract for color-eyre-kotlin. The longer
...
color-eyre-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`color-eyre`](https://crates.io/crates/color-eyre). Upstream Rust is the behavioral oracle while the
