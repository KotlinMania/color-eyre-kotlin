...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `ColorEyre.swiftmodule/`
...
//      `import ColorEyre` above would fail at compile time.
//
//   2. The static archive `libColorEyre.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "ColorEyre" }` and
//      `flattenPackage = "io.github.kotlinmania.coloreyre"` configuration in
...
//      via the `ColorEyreLibrary` product.
//
...
final class ColorEyreExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "ColorEyre swift module imported cleanly")
    }
}
